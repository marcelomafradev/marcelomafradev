...
interface SidebarCssVariables extends React.CSSProperties {
...
const mobileSidebarStyle: SidebarCssVariables = {
  '--sidebar-width': SIDEBAR_WIDTH_MOBILE,
};

const skeletonWidthStyle = (width: string): SidebarCssVariables => ({
    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delay={0}>
          <div
            style={sidebarLayoutStyle(style)}
            className={cn(
